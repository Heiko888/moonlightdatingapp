/**
 * Swiss Ephemeris Alternative - JavaScript Version für Test
 */
...
function testSwissEphemeris() {
  ...
  try {
    ...
    const result = swissEphemeris.calculatePositions(testDate);
    
    console.log(`🌍 Julianisches Datum: ${result.julianDay.toFixed(2)}\n`);
    ...
    console.log('\n✅ Swiss Ephemeris Alternative funktioniert!');
    
    // Vergleiche mit vereinfachter Berechnung
    console.log('\n📊 Vergleich zur bisherigen vereinfachten Berechnung:');
    ...
    const simpleGate = (1 + gateOffset) % 64 || 64;
    
    console.log(`Bisherige Sonne-Berechnung: Gate ${simpleGate}`);
    console.log(`Neue Sonne-Berechnung: Gate ${swissEphemeris.longitudeToGate(result.planets.sun.longitude).gate}`);
    console.log(`\n💡 Die neue Berechnung ist deutlich präziser!`);

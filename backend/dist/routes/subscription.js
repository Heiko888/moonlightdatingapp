...
const subscriptionDbPath = path_1.default.join(__dirname, '../../data/subscriptions.json');
// Abonnement-Datenbank initialisieren
function initSubscriptionDb() {
    const dir = path_1.default.dirname(subscriptionDbPath);
    if (!fs_1.default.existsSync(dir)) {
        fs_1.default.mkdirSync(dir, { recursive: true });
    }
    if (!fs_1.default.existsSync(subscriptionDbPath)) {
        ...
        fs_1.default.writeFileSync(subscriptionDbPath, JSON.stringify(demoSubscriptions, null, 2));
...
function loadSubscriptions() {
    try {
        ...
        const data = fs_1.default.readFileSync(subscriptionDbPath, 'utf8');
...
function saveSubscriptions(subscriptions) {
    try {
        fs_1.default.writeFileSync(subscriptionDbPath, JSON.stringify(subscriptions, null, 2));
    }
    catch (error) {
...
router.put('/user/:userId', (req, res) => {
    try {
        ...
        const subscriptions = loadSubscriptions();
        const subscriptionIndex = subscriptions.findIndex((sub) => sub.userId === userId);
        const now = new Date();
        ...
        const updatedSubscription = {
            id: subscriptionIndex >= 0 ? subscriptions[subscriptionIndex].id : (0, uuid_1.v4)(),
            userId,
            packageId,
            status: 'active',

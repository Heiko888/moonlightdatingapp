...
exports.RealTimeCoachingEngine = void 0;
...
class RealTimeCoachingEngine {
     ...
     */
    async provideRealTimeGuidance(userProfile, context, userMessage) {
        try {
            ...
            const coachingResponse = await this.generateCoachingResponse(userProfile, context, energyAssessment, contextAnalysis, userMessage);
     ...
     */
    async assessUserEnergy(userProfile, context) {
...
Antworte in JSON-Format:
{
  ...
  "warnings": ["Warnung1", "Warnung2"]
     ...
     */
    async analyzeContext(userProfile, context, userMessage) {
...
Antworte in strukturiertem JSON-Format.`;
     ...
     */
    async generateCoachingResponse(userProfile, context, energyAssessment, contextAnalysis, userMessage) {
...
Antworte in strukturiertem JSON-Format.`;
     ...
     */
    async generateProactiveCoaching(userProfile, context) {
        try {
     ...
     */
    async assessCoachingNeed(userProfile, context) {
...
Antworte in JSON-Format:
{
  ...
  "urgency": "low/medium/high"
     ...
     */
    validateCoachingResponse(response, userProfile) {
        return {
     ...
     */
    getDefaultCoachingResponse(userProfile) {
        return {
     ...
     */
    updateCoachingHistory(userId, response) {
     ...
     */
    async analyzeCoachingEffectiveness(userId) {
...
exports.RealTimeCoachingEngine = RealTimeCoachingEngine;
exports.default = new RealTimeCoachingEngine();

...
const dbPath = path_1.default.join(__dirname, '../../data/hd-app.db');
...
function initializeMercurySpecificData() {
  ...
  `);
    ...
    insertMercuryGate.run(mercuryGate1.id, mercuryGate1.planet_name, mercuryGate1.gate_number, mercuryGate1.name, mercuryGate1.essence, mercuryGate1.consciousness, mercuryGate1.description, mercuryGate1.deep_meaning, mercuryGate1.shadow_aspects, mercuryGate1.gifts, mercuryGate1.affirmation, mercuryGate1.center_name);
    ...
    insertMercuryGate.run(mercuryGate2.id, mercuryGate2.planet_name, mercuryGate2.gate_number, mercuryGate2.name, mercuryGate2.essence, mercuryGate2.consciousness, mercuryGate2.description, mercuryGate2.deep_meaning, mercuryGate2.shadow_aspects, mercuryGate2.gifts, mercuryGate2.affirmation, mercuryGate2.center_name);
    ...
    insertMercuryGate.run(mercuryGate3.id, mercuryGate3.planet_name, mercuryGate3.gate_number, mercuryGate3.name, mercuryGate3.essence, mercuryGate3.consciousness, mercuryGate3.description, mercuryGate3.deep_meaning, mercuryGate3.shadow_aspects, mercuryGate3.gifts, mercuryGate3.affirmation, mercuryGate3.center_name);
    ...
    insertMercuryGate.run(mercuryGate4.id, mercuryGate4.planet_name, mercuryGate4.gate_number, mercuryGate4.name, mercuryGate4.essence, mercuryGate4.consciousness, mercuryGate4.description, mercuryGate4.deep_meaning, mercuryGate4.shadow_aspects, mercuryGate4.gifts, mercuryGate4.affirmation, mercuryGate4.center_name);
    ...
    insertMercuryGate.run(mercuryGate5.id, mercuryGate5.planet_name, mercuryGate5.gate_number, mercuryGate5.name, mercuryGate5.essence, mercuryGate5.consciousness, mercuryGate5.description, mercuryGate5.deep_meaning, mercuryGate5.shadow_aspects, mercuryGate5.gifts, mercuryGate5.affirmation, mercuryGate5.center_name);
    ...
    insertMercuryGate.run(mercuryGate6.id, mercuryGate6.planet_name, mercuryGate6.gate_number, mercuryGate6.name, mercuryGate6.essence, mercuryGate6.consciousness, mercuryGate6.description, mercuryGate6.deep_meaning, mercuryGate6.shadow_aspects, mercuryGate6.gifts, mercuryGate6.affirmation, mercuryGate6.center_name);
    ...
    insertMercuryGate.run(mercuryGate7.id, mercuryGate7.planet_name, mercuryGate7.gate_number, mercuryGate7.name, mercuryGate7.essence, mercuryGate7.consciousness, mercuryGate7.description, mercuryGate7.deep_meaning, mercuryGate7.shadow_aspects, mercuryGate7.gifts, mercuryGate7.affirmation, mercuryGate7.center_name);
    ...
    insertMercuryGate.run(mercuryGate8.id, mercuryGate8.planet_name, mercuryGate8.gate_number, mercuryGate8.name, mercuryGate8.essence, mercuryGate8.consciousness, mercuryGate8.description, mercuryGate8.deep_meaning, mercuryGate8.shadow_aspects, mercuryGate8.gifts, mercuryGate8.affirmation, mercuryGate8.center_name);
    ...
    insertMercuryGate.run(mercuryGate9.id, mercuryGate9.planet_name, mercuryGate9.gate_number, mercuryGate9.name, mercuryGate9.essence, mercuryGate9.consciousness, mercuryGate9.description, mercuryGate9.deep_meaning, mercuryGate9.shadow_aspects, mercuryGate9.gifts, mercuryGate9.affirmation, mercuryGate9.center_name);
    ...
    insertMercuryGate.run(mercuryGate10.id, mercuryGate10.planet_name, mercuryGate10.gate_number, mercuryGate10.name, mercuryGate10.essence, mercuryGate10.consciousness, mercuryGate10.description, mercuryGate10.deep_meaning, mercuryGate10.shadow_aspects, mercuryGate10.gifts, mercuryGate10.affirmation, mercuryGate10.center_name);
    ...
    insertMercuryGate.run(mercuryGate12.id, mercuryGate12.planet_name, mercuryGate12.gate_number, mercuryGate12.name, mercuryGate12.essence, mercuryGate12.consciousness, mercuryGate12.description, mercuryGate12.deep_meaning, mercuryGate12.shadow_aspects, mercuryGate12.gifts, mercuryGate12.affirmation, mercuryGate12.center_name);
    ...
    insertMercuryGate.run(mercuryGate13.id, mercuryGate13.planet_name, mercuryGate13.gate_number, mercuryGate13.name, mercuryGate13.essence, mercuryGate13.consciousness, mercuryGate13.description, mercuryGate13.deep_meaning, mercuryGate13.shadow_aspects, mercuryGate13.gifts, mercuryGate13.affirmation, mercuryGate13.center_name);
    ...
    insertMercuryGate.run(mercuryGate14.id, mercuryGate14.planet_name, mercuryGate14.gate_number, mercuryGate14.name, mercuryGate14.essence, mercuryGate14.consciousness, mercuryGate14.description, mercuryGate14.deep_meaning, mercuryGate14.shadow_aspects, mercuryGate14.gifts, mercuryGate14.affirmation, mercuryGate14.center_name);
    ...
    insertMercuryGate.run(mercuryGate15.id, mercuryGate15.planet_name, mercuryGate15.gate_number, mercuryGate15.name, mercuryGate15.essence, mercuryGate15.consciousness, mercuryGate15.description, mercuryGate15.deep_meaning, mercuryGate15.shadow_aspects, mercuryGate15.gifts, mercuryGate15.affirmation, mercuryGate15.center_name);
    ...
    insertMercuryGate.run(mercuryGate16.id, mercuryGate16.planet_name, mercuryGate16.gate_number, mercuryGate16.name, mercuryGate16.essence, mercuryGate16.consciousness, mercuryGate16.description, mercuryGate16.deep_meaning, mercuryGate16.shadow_aspects, mercuryGate16.gifts, mercuryGate16.affirmation, mercuryGate16.center_name);
    ...
    insertMercuryGate.run(mercuryGate17.id, mercuryGate17.planet_name, mercuryGate17.gate_number, mercuryGate17.name, mercuryGate17.essence, mercuryGate17.consciousness, mercuryGate17.description, mercuryGate17.deep_meaning, mercuryGate17.shadow_aspects, mercuryGate17.gifts, mercuryGate17.affirmation, mercuryGate17.center_name);
    ...
    insertMercuryGate.run(mercuryGate18.id, mercuryGate18.planet_name, mercuryGate18.gate_number, mercuryGate18.name, mercuryGate18.essence, mercuryGate18.consciousness, mercuryGate18.description, mercuryGate18.deep_meaning, mercuryGate18.shadow_aspects, mercuryGate18.gifts, mercuryGate18.affirmation, mercuryGate18.center_name);
    ...
    insertMercuryGate.run(mercuryGate19.id, mercuryGate19.planet_name, mercuryGate19.gate_number, mercuryGate19.name, mercuryGate19.essence, mercuryGate19.consciousness, mercuryGate19.description, mercuryGate19.deep_meaning, mercuryGate19.shadow_aspects, mercuryGate19.gifts, mercuryGate19.affirmation, mercuryGate19.center_name);
    ...
    insertMercuryGate.run(mercuryGate20.id, mercuryGate20.planet_name, mercuryGate20.gate_number, mercuryGate20.name, mercuryGate20.essence, mercuryGate20.consciousness, mercuryGate20.description, mercuryGate20.deep_meaning, mercuryGate20.shadow_aspects, mercuryGate20.gifts, mercuryGate20.affirmation, mercuryGate20.center_name);
    ...
    insertMercuryGate.run(mercuryGate21.id, mercuryGate21.planet_name, mercuryGate21.gate_number, mercuryGate21.name, mercuryGate21.essence, mercuryGate21.consciousness, mercuryGate21.description, mercuryGate21.deep_meaning, mercuryGate21.shadow_aspects, mercuryGate21.gifts, mercuryGate21.affirmation, mercuryGate21.center_name);
    ...
    insertMercuryGate.run(mercuryGate22.id, mercuryGate22.planet_name, mercuryGate22.gate_number, mercuryGate22.name, mercuryGate22.essence, mercuryGate22.consciousness, mercuryGate22.description, mercuryGate22.deep_meaning, mercuryGate22.shadow_aspects, mercuryGate22.gifts, mercuryGate22.affirmation, mercuryGate22.center_name);
    ...
    insertMercuryGate.run(mercuryGate23.id, mercuryGate23.planet_name, mercuryGate23.gate_number, mercuryGate23.name, mercuryGate23.essence, mercuryGate23.consciousness, mercuryGate23.description, mercuryGate23.deep_meaning, mercuryGate23.shadow_aspects, mercuryGate23.gifts, mercuryGate23.affirmation, mercuryGate23.center_name);
    ...
    insertMercuryGate.run(mercuryGate24.id, mercuryGate24.planet_name, mercuryGate24.gate_number, mercuryGate24.name, mercuryGate24.essence, mercuryGate24.consciousness, mercuryGate24.description, mercuryGate24.deep_meaning, mercuryGate24.shadow_aspects, mercuryGate24.gifts, mercuryGate24.affirmation, mercuryGate24.center_name);
    ...
    insertMercuryGate.run(mercuryGate25.id, mercuryGate25.planet_name, mercuryGate25.gate_number, mercuryGate25.name, mercuryGate25.essence, mercuryGate25.consciousness, mercuryGate25.description, mercuryGate25.deep_meaning, mercuryGate25.shadow_aspects, mercuryGate25.gifts, mercuryGate25.affirmation, mercuryGate25.center_name);
    ...
    insertMercuryGate.run(mercuryGate26.id, mercuryGate26.planet_name, mercuryGate26.gate_number, mercuryGate26.name, mercuryGate26.essence, mercuryGate26.consciousness, mercuryGate26.description, mercuryGate26.deep_meaning, mercuryGate26.shadow_aspects, mercuryGate26.gifts, mercuryGate26.affirmation, mercuryGate26.center_name);
    ...
    insertMercuryGate.run(mercuryGate27.id, mercuryGate27.planet_name, mercuryGate27.gate_number, mercuryGate27.name, mercuryGate27.essence, mercuryGate27.consciousness, mercuryGate27.description, mercuryGate27.deep_meaning, mercuryGate27.shadow_aspects, mercuryGate27.gifts, mercuryGate27.affirmation, mercuryGate27.center_name);
    ...
    insertMercuryGate.run(mercuryGate28.id, mercuryGate28.planet_name, mercuryGate28.gate_number, mercuryGate28.name, mercuryGate28.essence, mercuryGate28.consciousness, mercuryGate28.description, mercuryGate28.deep_meaning, mercuryGate28.shadow_aspects, mercuryGate28.gifts, mercuryGate28.affirmation, mercuryGate28.center_name);
    ...
    insertMercuryGate.run(mercuryGate29.id, mercuryGate29.planet_name, mercuryGate29.gate_number, mercuryGate29.name, mercuryGate29.essence, mercuryGate29.consciousness, mercuryGate29.description, mercuryGate29.deep_meaning, mercuryGate29.shadow_aspects, mercuryGate29.gifts, mercuryGate29.affirmation, mercuryGate29.center_name);
    ...
    insertMercuryGate.run(mercuryGate30.id, mercuryGate30.planet_name, mercuryGate30.gate_number, mercuryGate30.name, mercuryGate30.essence, mercuryGate30.consciousness, mercuryGate30.description, mercuryGate30.deep_meaning, mercuryGate30.shadow_aspects, mercuryGate30.gifts, mercuryGate30.affirmation, mercuryGate30.center_name);
    ...
    insertMercuryGate.run(mercuryGate31.id, mercuryGate31.planet_name, mercuryGate31.gate_number, mercuryGate31.name, mercuryGate31.essence, mercuryGate31.consciousness, mercuryGate31.description, mercuryGate31.deep_meaning, mercuryGate31.shadow_aspects, mercuryGate31.gifts, mercuryGate31.affirmation, mercuryGate31.center_name);
    ...
    insertMercuryGate.run(mercuryGate32.id, mercuryGate32.planet_name, mercuryGate32.gate_number, mercuryGate32.name, mercuryGate32.essence, mercuryGate32.consciousness, mercuryGate32.description, mercuryGate32.deep_meaning, mercuryGate32.shadow_aspects, mercuryGate32.gifts, mercuryGate32.affirmation, mercuryGate32.center_name);
    ...
    insertMercuryGate.run(mercuryGate33.id, mercuryGate33.planet_name, mercuryGate33.gate_number, mercuryGate33.name, mercuryGate33.essence, mercuryGate33.consciousness, mercuryGate33.description, mercuryGate33.deep_meaning, mercuryGate33.shadow_aspects, mercuryGate33.gifts, mercuryGate33.affirmation, mercuryGate33.center_name);
    ...
    insertMercuryGate.run(mercuryGate34.id, mercuryGate34.planet_name, mercuryGate34.gate_number, mercuryGate34.name, mercuryGate34.essence, mercuryGate34.consciousness, mercuryGate34.description, mercuryGate34.deep_meaning, mercuryGate34.shadow_aspects, mercuryGate34.gifts, mercuryGate34.affirmation, mercuryGate34.center_name);
    ...
    insertMercuryGate.run(mercuryGate35.id, mercuryGate35.planet_name, mercuryGate35.gate_number, mercuryGate35.name, mercuryGate35.essence, mercuryGate35.consciousness, mercuryGate35.description, mercuryGate35.deep_meaning, mercuryGate35.shadow_aspects, mercuryGate35.gifts, mercuryGate35.affirmation, mercuryGate35.center_name);
    ...
    insertMercuryGate.run(mercuryGate36.id, mercuryGate36.planet_name, mercuryGate36.gate_number, mercuryGate36.name, mercuryGate36.essence, mercuryGate36.consciousness, mercuryGate36.description, mercuryGate36.deep_meaning, mercuryGate36.shadow_aspects, mercuryGate36.gifts, mercuryGate36.affirmation, mercuryGate36.center_name);
    ...
    insertMercuryGate.run(mercuryGate37.id, mercuryGate37.planet_name, mercuryGate37.gate_number, mercuryGate37.name, mercuryGate37.essence, mercuryGate37.consciousness, mercuryGate37.description, mercuryGate37.deep_meaning, mercuryGate37.shadow_aspects, mercuryGate37.gifts, mercuryGate37.affirmation, mercuryGate37.center_name);
    ...
    insertMercuryGate.run(mercuryGate38.id, mercuryGate38.planet_name, mercuryGate38.gate_number, mercuryGate38.name, mercuryGate38.essence, mercuryGate38.consciousness, mercuryGate38.description, mercuryGate38.deep_meaning, mercuryGate38.shadow_aspects, mercuryGate38.gifts, mercuryGate38.affirmation, mercuryGate38.center_name);
    ...
    insertMercuryGate.run(mercuryGate39.id, mercuryGate39.planet_name, mercuryGate39.gate_number, mercuryGate39.name, mercuryGate39.essence, mercuryGate39.consciousness, mercuryGate39.description, mercuryGate39.deep_meaning, mercuryGate39.shadow_aspects, mercuryGate39.gifts, mercuryGate39.affirmation, mercuryGate39.center_name);
    ...
    insertMercuryGate.run(mercuryGate42.id, mercuryGate42.planet_name, mercuryGate42.gate_number, mercuryGate42.name, mercuryGate42.essence, mercuryGate42.consciousness, mercuryGate42.description, mercuryGate42.deep_meaning, mercuryGate42.shadow_aspects, mercuryGate42.gifts, mercuryGate42.affirmation, mercuryGate42.center_name);
    ...
    insertMercuryGate.run(mercuryGate43.id, mercuryGate43.planet_name, mercuryGate43.gate_number, mercuryGate43.name, mercuryGate43.essence, mercuryGate43.consciousness, mercuryGate43.description, mercuryGate43.deep_meaning, mercuryGate43.shadow_aspects, mercuryGate43.gifts, mercuryGate43.affirmation, mercuryGate43.center_name);
    ...
    insertMercuryGate.run(mercuryGate40.id, mercuryGate40.planet_name, mercuryGate40.gate_number, mercuryGate40.name, mercuryGate40.essence, mercuryGate40.consciousness, mercuryGate40.description, mercuryGate40.deep_meaning, mercuryGate40.shadow_aspects, mercuryGate40.gifts, mercuryGate40.affirmation, mercuryGate40.center_name);
    ...
    insertMercuryGate.run(mercuryGate41.id, mercuryGate41.planet_name, mercuryGate41.gate_number, mercuryGate41.name, mercuryGate41.essence, mercuryGate41.consciousness, mercuryGate41.description, mercuryGate41.deep_meaning, mercuryGate41.shadow_aspects, mercuryGate41.gifts, mercuryGate41.affirmation, mercuryGate41.center_name);
...
exports.localDb = {
    ...
    getPlanetGatesFirst8: (planetName) => {
    ...
    `);
        const id = Math.random().toString(36).substr(2, 9);
        return stmt.run(id, chartData.user_id, chartData.name, chartData.birth_date, chartData.birth_time, chartData.birth_place, JSON.stringify(chartData.chart_data));
    },
    ...
    // Knowledge
    createKnowledgeItem: (itemData) => {
        const stmt = db.prepare(`
      INSERT INTO knowledge_items (id, title, content, type, ref_key, scope, quality)
      VALUES (?, ?, ?, ?, ?, ?, ?)
    `);
        const id = Math.random().toString(36).substr(2, 9);
        return stmt.run(id, itemData.title, itemData.content, itemData.type, itemData.ref_key, itemData.scope, itemData.quality || 'draft');
    },
    getKnowledgeItems: (type) => {
        if (type) {
    ...
    `);
        const id = Math.random().toString(36).substr(2, 9);
        return stmt.run(id, swipeData.user_id, swipeData.target_id, swipeData.liked, swipeData.is_super_like || false, swipeData.compatibility_score || 0);
    },
    getSwipesByUserId: (userId) => {
    ...
    `);
        const id = Math.random().toString(36).substr(2, 9);
        return stmt.run(id, matchData.user_a, matchData.user_b, matchData.compatibility_score, matchData.relationship_type || 'romantic');
    },
    ...
    createCompatibilityAnalysis: (analysisData) => {
        const stmt = db.prepare(`
    ...
    `);
        const id = Math.random().toString(36).substr(2, 9);
        return stmt.run(id, analysisData.user_a, analysisData.user_b, analysisData.overall_score, JSON.stringify(analysisData.breakdown), JSON.stringify(analysisData.strengths), JSON.stringify(analysisData.challenges), JSON.stringify(analysisData.recommendations), JSON.stringify(analysisData.detailed_analysis), analysisData.relationship_type || 'romantic');
    },
    getCompatibilityAnalysis: (userA, userB) => {
        const stmt = db.prepare(`
    ...
    // Match Feedback
    createMatchFeedback: (feedbackData) => {
        const stmt = db.prepare(`
      INSERT INTO match_feedback (id, user_id, target_id, match_id, rating, feedback, categories)
      VALUES (?, ?, ?, ?, ?, ?, ?)
    `);
        const id = Math.random().toString(36).substr(2, 9);
        return stmt.run(id, feedbackData.user_id, feedbackData.target_id, feedbackData.match_id, feedbackData.rating, feedbackData.feedback, JSON.stringify(feedbackData.categories || []));
    }
};
...
function updateMercuryGate(gateNumber, gateData) {
    ...
    `);
        const result = updateGate.run(gateData.name || null, gateData.essence || null, gateData.consciousness || null, gateData.description || null, gateData.deep_meaning || null, gateData.shadow_aspects ? JSON.stringify(gateData.shadow_aspects) : null, gateData.gifts ? JSON.stringify(gateData.gifts) : null, gateData.affirmation || null, gateData.personal_affirmation || null, gateData.business_affirmation || null, gateData.business_description || null, gateNumber);
...
function getMercuryGate(gateNumber) {
    try {
      ...
      WHERE planet_name = 'Merkur' AND gate_number = ?
    `);
        const gate = getGate.get(gateNumber);
        if (gate) {
            // JSON-Felder parsen

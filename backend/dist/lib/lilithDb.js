...
exports.getAllLilithCenters = getAllLilithCenters;
exports.getLilithCenter = getLilithCenter;
exports.getAllLilithGates = getAllLilithGates;
exports.getLilithGate = getLilithGate;
exports.getLilithGatesByCenter = getLilithGatesByCenter;
exports.closeLilithDatabase = closeLilithDatabase;
...
function initializeLilithBasicData() {
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
  `);
    insertLilithInfo.run(lilithInfo.id, lilithInfo.name, lilithInfo.symbol, lilithInfo.orbital_period, lilithInfo.discovery, lilithInfo.mythology, lilithInfo.color, lilithInfo.description);
  ...
  `);
    ...
    lilithGatesData.forEach(gateData => {
        ...
        insertLilithGate.run(id, gateData.gate, gateData.name, gateData.essence, gateData.consciousness, gateData.description, gateData.deepMeaning, JSON.stringify(gateData.shadowAspects), JSON.stringify(gateData.gifts), gateData.affirmation, centerName);
    });

...
exports.HumanDesignDataService = exports.TYPES = exports.CENTERS = exports.CHANNELS = exports.GATES = void 0;
/**
...
class HumanDesignDataService {
    ...
    static getChannel(gate1, gate2) {
        ...
        return exports.CHANNELS[channelKey1] || exports.CHANNELS[channelKey2];
    }
    /**
     * Gibt das Zentrum für ein bestimmtes Gate zurück
     */
    static getCenterForGate(gateNumber) {
        const gate = exports.GATES[gateNumber];
        return gate?.center;
    }
    /**
     * Prüft ob zwei Gates einen Kanal bilden
     */
    static isChannelActive(gate1, gate2) {
...
exports.HumanDesignDataService = HumanDesignDataService;
exports.default = HumanDesignDataService;

...
export const themes: { [key: string]: Theme } = {
  cosmic: {
    id: 'cosmic',
    name: 'Kosmisch',
    description: 'Tiefe Raumfarben mit leuchtenden Akzenten',
    isDark: true,
    category: 'cosmic',
    colors: {
      ...
      centerActive: '#8b5cf6',
      centerInactive: 'rgba(139,92,246,0.3)',
      channelActive: '#fbbf24',
      channelInactive: 'rgba(251,191,36,0.3)',
      gateActive: '#10b981',
      gateInactive: 'rgba(16,185,129,0.3)',
      planetActive: '#ec4899',
      planetInactive: 'rgba(236,72,153,0.3)',
      primary: '#8b5cf6',
      secondary: '#a855f7',
      accent: '#fbbf24',
      success: '#22c55e',

...
export default function ReflectorSalesPage() {
  const benefits = [
    {
      icon: <Moon size={32} />,
      title: "Verstehe deine Spiegel-Energie",
      description: "Lerne, wie du deine natürliche Fähigkeit zu reflektieren optimal nutzt."
    },
    {
      icon: <Brain size={32} />,
      title: "Entscheidungsfindung optimieren",
      description: "Entdecke, wie du durch Reflexion und Beobachtung bessere Entscheidungen triffst."
    },
    {
      icon: <Workflow size={32} />,
      title: "Arbeitsprozesse verbessern",
      description: "Finde deine beste Arbeitsweise als Reflektor und optimiere deine Routinen."
    },
    {
      icon: <HeartIcon size={32} />,
      title: "Beziehungen vertiefen",
      description: "Verstehe, wie deine Spiegel-Energie deine Beziehungen beeinflusst."
    },
    {
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2 }}>
        ...
        >
          <Box textAlign="center" mb={8}>
            <Chip
              label="🌙 Speziell für Reflektoren entwickelt"
              sx={{
            ...
            >
              Entdecke deine Spiegel-Energie
            </Typography>
            ...
            >
              Du bist hier, um zu reflektieren und zu spiegeln. Lerne, wie du deine natürliche 
              Reflektor-Energie optimal nutzen und dein volles Potenzial entfalten kannst.
            </Typography>
        ...
        <Box sx={{ py: 8 }}>
          ...
          >
            <Box sx={{ textAlign: 'center', mb: 8 }}>
              ...
              >
                Warum Human Design für Reflektoren?
              </Typography>
            </Box>
          ...
          <Container maxWidth="lg">
            ...
            >
              <Box sx={{ textAlign: 'center', mb: 6 }}>
                ...
                >
                  Spezielle Features für Reflektoren
                </Typography>
              </Box>
          ...
          >
            <Card sx={{ 
              ...
              <Typography variant="h5" sx={{ color: 'rgba(255,255,255,0.9)', mb: 4, lineHeight: 1.6, fontStyle: 'italic', textAlign: 'center', textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
                &ldquo;Endlich verstehe ich meine Spiegel-Energie! Ich weiß jetzt, wie ich 
                durch Reflexion und Beobachtung bessere Entscheidungen treffen kann.&rdquo;
              </Typography>
          ...
          >
            <Card sx={{ 
              ...
              <Typography variant="h2" sx={{ color: 'white', fontWeight: 800, mb: 3, textShadow: '0 0 20px rgba(255, 255, 255, 0.3)' }}>
                Bereit für deine Reflektor-Transformation?
              </Typography>
              <Typography variant="h5" sx={{ color: 'rgba(255,255,255,0.8)', mb: 4, lineHeight: 1.6, textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
                Entdecke dein volles Potenzial und lerne, wie du deine Spiegel-Energie optimal nutzen kannst
              </Typography>

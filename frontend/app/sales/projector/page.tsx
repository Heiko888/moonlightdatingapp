...
export default function ProjectorSalesPage() {
  const benefits = [
    {
      icon: <Eye size={32} />,
      title: "Verstehe deine Führungsenergie",
      description: "Lerne, wie du deine natürliche Fähigkeit zu sehen und zu führen optimal nutzt."
    },
    {
      icon: <Brain size={32} />,
      title: "Entscheidungsfindung optimieren",
      description: "Entdecke, wie du auf Einladungen wartest und dann die richtigen Entscheidungen triffst."
    },
    {
      icon: <Workflow size={32} />,
      title: "Arbeitsprozesse verbessern",
      description: "Finde deine beste Arbeitsweise als Projektor und optimiere deine Routinen."
    },
    {
      icon: <HeartIcon size={32} />,
      title: "Beziehungen vertiefen",
      description: "Verstehe, wie deine Projektor-Energie deine Beziehungen beeinflusst."
    },
    {
      icon: <UsersIcon size={32} />,
      title: "Teamarbeit optimieren",
      description: "Lerne, wie du am besten mit anderen zusammenarbeitest und geführt wirst."
    },
    {
      icon: <Play size={32} />,
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2 }}>
        ...
        >
          <Box textAlign="center" mb={8}>
            <Chip
              label="👁️ Speziell für Projektoren entwickelt"
              sx={{
            ...
            >
              Entdecke deine Führungsenergie
            </Typography>
            ...
            >
              Du bist hier, um zu sehen und zu führen. Lerne, wie du deine natürliche 
              Projektor-Energie optimal nutzen und dein volles Potenzial entfalten kannst.
            </Typography>
        ...
        <Box sx={{ py: 8 }}>
          ...
          >
            <Box sx={{ textAlign: 'center', mb: 8 }}>
              ...
              >
                Warum Human Design für Projektoren?
              </Typography>
            </Box>
          ...
          <Container maxWidth="lg">
            ...
            >
              <Box sx={{ textAlign: 'center', mb: 6 }}>
                ...
                >
                  Spezielle Features für Projektoren
                </Typography>
              </Box>
          ...
          >
            <Card sx={{ 
              ...
              <Typography variant="h5" sx={{ color: 'rgba(255,255,255,0.9)', mb: 4, lineHeight: 1.6, fontStyle: 'italic', textAlign: 'center', textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
                &ldquo;Endlich verstehe ich meine Führungsenergie! Ich weiß jetzt, wann ich warten 
                und wann ich handeln soll. Das hat mein Leben komplett verändert.&rdquo;
              </Typography>
          ...
          >
            <Card sx={{ 
              ...
              <Typography variant="h2" sx={{ color: 'white', fontWeight: 800, mb: 3, textShadow: '0 0 20px rgba(255, 255, 255, 0.3)' }}>
                Bereit für deine Projektor-Transformation?
              </Typography>
              <Typography variant="h5" sx={{ color: 'rgba(255,255,255,0.8)', mb: 4, lineHeight: 1.6, textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
                Entdecke dein volles Potenzial und lerne, wie du deine Führungsenergie optimal nutzen kannst
              </Typography>

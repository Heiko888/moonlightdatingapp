...
export default function ManifestorSalesPage() {
  const benefits = [
    {
      icon: <Zap size={32} />,
      title: "Verstehe deine Initiator-Energie",
      description: "Lerne, wie du deine natürliche Fähigkeit zu initiieren optimal nutzt."
    },
    {
      icon: <Brain size={32} />,
      title: "Entscheidungsfindung optimieren",
      description: "Entdecke, wie du deine Impulse richtig nutzen und bessere Entscheidungen triffst."
    },
    {
      icon: <Workflow size={32} />,
      title: "Arbeitsprozesse verbessern",
      description: "Finde deine beste Arbeitsweise als Manifestor und optimiere deine Routinen."
    },
    {
      icon: <HeartIcon size={32} />,
      title: "Beziehungen vertiefen",
      description: "Verstehe, wie deine Manifestor-Energie deine Beziehungen beeinflusst."
    },
    {
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2 }}>
        ...
        >
          <Box textAlign="center" mb={8}>
            <Chip
              label="⚡ Speziell für Manifestoren entwickelt"
              sx={{
            ...
            >
              Entdecke deine Initiator-Energie
            </Typography>
            ...
            >
              Du bist hier, um zu initiieren und Neues zu erschaffen. Lerne, wie du deine natürliche 
              Manifestor-Energie optimal nutzen und dein volles Potenzial entfalten kannst.
            </Typography>
        ...
        <Box sx={{ py: 8 }}>
          ...
          >
            <Box sx={{ textAlign: 'center', mb: 8 }}>
              ...
              >
                Warum Human Design für Manifestoren?
              </Typography>
            </Box>
          ...
          <Container maxWidth="lg">
            ...
            >
              <Box sx={{ textAlign: 'center', mb: 6 }}>
                ...
                >
                  Spezielle Features für Manifestoren
                </Typography>
              </Box>
          ...
          >
            <Card sx={{ 
              ...
              <Typography variant="h5" sx={{ color: 'rgba(255,255,255,0.9)', mb: 4, lineHeight: 1.6, fontStyle: 'italic', textAlign: 'center', textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
                &ldquo;Endlich verstehe ich meine Initiator-Energie! Ich weiß jetzt, wie ich 
                meine Impulse richtig nutzen und bessere Entscheidungen treffen kann.&rdquo;
              </Typography>
          ...
          >
            <Card sx={{ 
              ...
              <Typography variant="h2" sx={{ color: 'white', fontWeight: 800, mb: 3, textShadow: '0 0 20px rgba(255, 255, 255, 0.3)' }}>
                Bereit für deine Manifestor-Transformation?
              </Typography>
              <Typography variant="h5" sx={{ color: 'rgba(255,255,255,0.8)', mb: 4, lineHeight: 1.6, textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
                Entdecke dein volles Potenzial und lerne, wie du deine Initiator-Energie optimal nutzen kannst
              </Typography>

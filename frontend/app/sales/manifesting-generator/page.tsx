...
export default function ManifestingGeneratorSalesPage() {
  const benefits = [
    {
      icon: <Zap size={32} />,
      title: "Verstehe deine duale Energie",
      description: "Lerne, wie du deine Generator- und Manifestor-Energie optimal kombinierst."
    },
    {
      icon: <Brain size={32} />,
      title: "Entscheidungsfindung optimieren",
      description: "Entdecke, wann du informieren und wann du direkt handeln solltest."
    },
    {
      icon: <Workflow size={32} />,
      title: "Arbeitsprozesse verbessern",
      description: "Finde deine beste Balance zwischen Reaktion und Initiative."
    },
    {
      icon: <HeartIcon size={32} />,
      title: "Beziehungen vertiefen",
      description: "Verstehe, wie deine duale Energie deine Beziehungen beeinflusst."
    },
    {
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2 }}>
        ...
        >
          <Box textAlign="center" mb={8}>
            <Chip
              label="⚡ Speziell für Manifesting Generatoren entwickelt"
              sx={{
            ...
            >
              Du bist hier, um zu arbeiten UND zu initiieren. Lerne, wie du deine einzigartige 
              duale Energie optimal nutzen und dein volles Potenzial entfalten kannst.
            </Typography>
        ...
        <Box sx={{ py: 8 }}>
          ...
          >
            <Box sx={{ textAlign: 'center', mb: 8 }}>
              ...
              >
                Warum Human Design für Manifesting Generatoren?
              </Typography>
            </Box>
          ...
          <Container maxWidth="lg">
            ...
            >
              <Box sx={{ textAlign: 'center', mb: 6 }}>
                ...
                >
                  Spezielle Features für Manifesting Generatoren
                </Typography>
              </Box>
            ...
            <Card sx={{ 
              ...
              <Box sx={{ textAlign: 'center', mb: 4 }}>
                <Typography variant="h3" sx={{ color: 'white', fontWeight: 800, mb: 2, textShadow: '0 0 20px rgba(255, 255, 255, 0.3)' }}>
                  Was andere Manifesting Generatoren sagen
                </Typography>
              </Box>
              ...
              <Typography variant="h5" sx={{ color: 'rgba(255,255,255,0.9)', mb: 4, lineHeight: 1.6, fontStyle: 'italic', textAlign: 'center', textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
                &ldquo;Endlich verstehe ich meine duale Energie! Ich weiß jetzt, wann ich informieren 
                und wann ich direkt handeln soll. Das hat mein Leben komplett verändert.&rdquo;
              </Typography>
          ...
          >
            <Card sx={{ 
              ...
              <Typography variant="h2" sx={{ color: 'white', fontWeight: 800, mb: 3, textShadow: '0 0 20px rgba(255, 255, 255, 0.3)' }}>
                Bereit für deine Manifesting Generator-Transformation?
              </Typography>
              <Typography variant="h5" sx={{ color: 'rgba(255,255,255,0.8)', mb: 4, lineHeight: 1.6, textShadow: '0 2px 10px rgba(0,0,0,0.3)' }}>
                Entdecke dein volles Potenzial und lerne, wie du deine duale Energie optimal nutzen kannst
              </Typography>

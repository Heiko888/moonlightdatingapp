...
import { Star, MapPin, Heart, Sparkles, ArrowLeft, Users, BookOpen, User, Mail, Phone, Calendar, Clock, MessageSquare, Send } from "lucide-react";
...
export default function LouisaProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("http://localhost:4001/sessionrequest", {
        ...
        body: JSON.stringify({ ...form, coach: "Louisa Ebisch" })
      });
      const data = await res.json();
      
      if (data.success) {
        setSuccess("Session-Anfrage erfolgreich versendet! Louisa meldet sich bald bei dir. ✨");
              ...
              <Box sx={{ 
                ...
                >
                  ...
                  <Typography variant="h6" sx={{ 
                    ...
                    Human Design Coach & Persönlichkeitsentwicklerin
                  </Typography>
              ...
              <CardContent sx={{ p: 4 }}>
                ...
                >
                  ...
                  <Typography variant="body1" sx={{ 
                    ...
                    Als erfahrene Human Design Coachin helfe ich Menschen dabei, ihre authentische 
                    Natur zu entdecken und ihr volles Potenzial zu entfalten. Meine Arbeit basiert 
                    auf Empathie, Erfahrung und einem tiefen Verständnis der menschlichen Psyche.
                  </Typography>
                  ...
                  <Typography variant="body1" sx={{ 
                    ...
                    Ich spezialisiere mich auf persönliche 1:1 Sessions, detaillierte Readings 
                    und maßgeschneidertes Human Design Coaching für individuelle Bedürfnisse.
                  </Typography>
                  ...
                  <Box sx={{ mb: 4 }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                      {['1:1 Coaching', 'Human Design Readings', 'Persönlichkeitsentwicklung', 'Yoga', 'Energiearbeit'].map((spec, index) => (
                        <Chip 
                          key={spec}
                          label={spec} 
                          sx={{ 

...
import { Star, MapPin, Heart, Sparkles, ArrowLeft, Users, BookOpen, TrendingUp, User, Mail, Phone, Calendar, Clock, MessageSquare, Send } from "lucide-react";
                ...
                >
                  ...
                  <Box sx={{ mb: 4 }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                      {['Human Design Basics', 'Chart-Analyse', 'Business Coaching', 'Energetische Potenzialentfaltung', 'Persönlichkeitsentwicklung'].map((spec, index) => (
                        <Chip 
                          key={spec}
                          label={spec} 
                          sx={{ 

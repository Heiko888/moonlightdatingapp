...
const allPages = [
  ...
  { id: 'profil-einrichten', title: 'Profil einrichten', path: '/profil-einrichten', description: 'Profil erstmalig einrichten', category: 'Benutzer', package: 'basic', icon: '🔧', features: ['Setup', 'Einrichtung'] },
